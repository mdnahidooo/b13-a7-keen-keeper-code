    ...
    return (
        <div>
            <footer className="footer footer-horizontal footer-center bg-[#244D3F] text-white p-10">
                <aside>
                    <h1 className='text-5xl font-extrabold pt-8 mb-2'>KeenKeeper</h1>
                ...
                <div className="w-11/12 md:w-10/12 mx-auto border-t border-gray-600 mt-5">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-169 py-5 text-sm text-gray-400">
                        ...
                        <p className="text-center md:text-left leading-relaxed">
                            ...
                            <span className="font-semibold text-gray-200">KeenKeeper</span>. All rights reserved
                        </p>

                        {/* RIGHT */}
                        <div className="flex flex-wrap sm:flex-nowrap justify-center md:justify-end items-center gap-3 sm:gap-5 md:gap-6">
